...
(function (global, factory) {
    ...
    */
                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) {
                        ...
                        getImage(source, srcset).then(
                            function (img) { return this$1.setItem(item, ("<img width=\"" + (img.width) + "\" height=\"" + (img.height) + "\" src=\"" + source + "\" alt=\"" + (alt ? alt : '') + "\" srcset=\"" + (srcset ? srcset : '') + "\">")); },
    ...
    function toItem(el) {
        return ['href', 'caption', 'type', 'poster', 'alt', 'srcset'].reduce(function (obj, attr) {
